  ...
  return (
    <div className='bg-slate-200 w-full min-h-[100vh]'>
      ...
      <div className='flex flex-wrap justify-center items-center gap-5 w-[100%]'>
        {Categories.map((item) => (
          <div key={item.id} className='w-[140px] h-[150px] bg-white flex flex-col items-start gap-5 p-5 justify-start 
      ...
      <div className={`w-full md:w-[40vw] h-[100%] fixed top-0 right-0 bg-white shadow-xl p-6 transition-all 
        duration-500  flex flex-col items-center overflow-auto ${showCart?"translate-x-0":"translate-x-full"}`}>
...
onClick={()=>setShowCart(false)}/>
      ...
      {items.map((item)=>(
        ...
        <button className='w-[80%] p-3 bg-green-500 rounded-lg text-white hover:bg-green-400 transition-all '>Place Order</button>
